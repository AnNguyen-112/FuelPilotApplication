...
//Testing get user Address
describe("Get /fuelquote/quoteform/getaddress", () => {
  it("should return message error: user not found with status code 404", (done) => {
    const user_email = "invaid@test.com";
    chai
      .request(server)
      .get(`/quoteform/getaddress?userEmail=${user_email}`)
      .end((err, res) => {
        res.should.have.status(404);
  ...
  it("should return message  user profile not found when user don't have user profile yet", (done) => {
  ...
  it("should return user address", (done) => {
    const user_email = "test1@test.com";
    chai
      .request(server)
      .get(`/quoteform/getaddress?userEmail=${user_email}`)
